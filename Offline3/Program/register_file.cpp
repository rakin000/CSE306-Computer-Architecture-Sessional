...
int main(void)
{
	...
	unsigned char in, temp , temp2,location,write_data,mem_to_reg,memread,memwrite,read_data,memory_data=0;
	while (1)
	{
		in = PINB;
		write_data = (unsigned char)(in & 0xF0) ;
